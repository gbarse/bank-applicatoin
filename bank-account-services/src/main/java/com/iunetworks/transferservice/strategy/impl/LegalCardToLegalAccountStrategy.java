...
public class LegalCardToLegalAccountStrategy implements TransferStrategy {
  ...
  public LegalCardToLegalAccountStrategy(TransactionAmountService rateService,
  ...
  public AmountTransferType byType() {
    return AmountTransferType.LEGAL_CARD_TO_LEGAL_ACCOUNT;
  }
