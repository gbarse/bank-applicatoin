...
public class PhysicalAccountToLegalCardStrategy implements TransferStrategy {
  ...
  public PhysicalAccountToLegalCardStrategy(final TransactionAmountService rateService,
  ...
  public AmountTransferType byType() {
    return AmountTransferType.PHYSICAL_ACCOUNT_TO_LEGAL_CARD;
  }
