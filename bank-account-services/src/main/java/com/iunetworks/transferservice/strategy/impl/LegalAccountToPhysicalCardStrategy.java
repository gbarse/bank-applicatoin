...
public class LegalAccountToPhysicalCardStrategy implements TransferStrategy {
  ...
  public LegalAccountToPhysicalCardStrategy(TransactionAmountService rateService,
                                            LegalAccountRepository legalEntityAccountsRepository, PhCreditCardRepository phCreditCardRepository) {
  ...
  public AmountTransferType byType() {
    return AmountTransferType.LEGAL_ACCOUNT_TO_PHYSICAL_CARD;
  }
